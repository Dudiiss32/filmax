...
@section('content')
    <div class="flex gap-5 items-center">
        ...
        <p class="font-bold text-2xl">Todas Categorias <span class="italic text-[#6100FF] text-4xl">!</span></p>
    </div>
            ...
            <div class="bg-white rounded-full shadow-xl p-4 flex items-center justify-between text-[#6000FD]">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('categorias.edit', $cat->id) }}"
                        class="flex border-2 border-[#6100FF] hover:bg-[#6100FF] p-2 w-fit rounded-full transition items-center cursor-pointer hover:text-white">
